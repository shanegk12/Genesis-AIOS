...
exec python scripts/pm_agent.py --course both --batch 20 --type all --generate-images --generate-interactives --generate-assessments --generate-scorm --import-to-platform
